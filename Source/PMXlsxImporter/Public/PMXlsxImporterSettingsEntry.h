...
public:
	...
	// to fix itself.
	UPROPERTY(EditAnywhere, Config, Category = XlsxImporter, meta = (GetOptions="GetWorksheetNames"))
	FString WorksheetName;

	UPROPERTY(EditAnywhere, Config, Category = XlsxImporter, meta = (RelativeToGameContentDir))
